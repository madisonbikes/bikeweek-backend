...
* bump @hono/node-server from 1.13.8 to 1.14.0 ([ee547e3](https://github.com/madisonbikes/bikeweek-backend/commit/ee547e3876e57360a2762fea5afe33cc7071849c))
* bump @hono/node-server from 1.13.8 to 1.14.0 ([03b7233](https://github.com/madisonbikes/bikeweek-backend/commit/03b7233a1a90dd981eb4e624b048465d25d949ae))
* bump @hono/node-server from 1.14.0 to 1.14.1 ([a0fd486](https://github.com/madisonbikes/bikeweek-backend/commit/a0fd486430d6a29511c4f5c1b92e7cb13c6b9d09))
* bump @hono/node-server from 1.14.0 to 1.14.1 ([e5fe2e6](https://github.com/madisonbikes/bikeweek-backend/commit/e5fe2e659169435a65863bab4013bf02991340a8))
* bump @hono/zod-validator from 0.4.3 to 0.5.0 ([4ebdc3f](https://github.com/madisonbikes/bikeweek-backend/commit/4ebdc3f4acb2fa7436b7fb55a67d0b291eda08da))
* bump @hono/zod-validator from 0.4.3 to 0.5.0 ([9171602](https://github.com/madisonbikes/bikeweek-backend/commit/9171602b6f04724f5316d6ef4da566fa0a79797e))
* bump bcryptjs from 2.4.3 to 3.0.2 ([6336bae](https://github.com/madisonbikes/bikeweek-backend/commit/6336bae1b522313e04635da58c4329adc5dc3718))
...
* bump connect-redis from 7.1.1 to 8.0.1 ([aefd886](https://github.com/madisonbikes/bikeweek-backend/commit/aefd886c600878e45900e005ae5e534bbbf3010b))
...
* bump connect-redis from 8.0.1 to 8.0.2 ([8067fa5](https://github.com/madisonbikes/bikeweek-backend/commit/8067fa56f816ef390db24be0474eef5d58c6a4ba))
* bump connect-redis from 8.0.1 to 8.0.2 ([63be7d9](https://github.com/madisonbikes/bikeweek-backend/commit/63be7d91bf5d60025c015a5caf32709ee70c038b))
* bump connect-redis from 8.0.2 to 8.0.3 ([be57c32](https://github.com/madisonbikes/bikeweek-backend/commit/be57c32d1c2e462eb64386ea6612eee6a8e4d820))
* bump connect-redis from 8.0.2 to 8.0.3 ([eadf091](https://github.com/madisonbikes/bikeweek-backend/commit/eadf09143b6d382c32d44c9fdb9f6bf913c2c321))
* bump date-fns from 3.6.0 to 4.1.0 ([5c554fe](https://github.com/madisonbikes/bikeweek-backend/commit/5c554fe5baa191df665c715ee0249a1b5862625a))
...
* bump dotenv from 16.4.5 to 16.4.7 ([6d7eab8](https://github.com/madisonbikes/bikeweek-backend/commit/6d7eab8a6eebe68c8509d461fa5e9f3258db74c6))
...
* bump dotenv from 16.4.7 to 16.5.0 ([3610309](https://github.com/madisonbikes/bikeweek-backend/commit/3610309c81cf7297db29fa19eebef6ff7cadcd64))
* bump dotenv from 16.4.7 to 16.5.0 ([4da3d7f](https://github.com/madisonbikes/bikeweek-backend/commit/4da3d7f6f744a968f5c6cf05c11d425de59ec47e))
* bump express from 4.19.2 to 4.21.2 ([4342e98](https://github.com/madisonbikes/bikeweek-backend/commit/4342e98e689504f8e130f222c555d1effd78e443))
...
* bump google-auth-library from 9.10.0 to 9.11.0 ([f300c2f](https://github.com/madisonbikes/bikeweek-backend/commit/f300c2f47b00a8b1cad439a55ae60d2599e51139))
...
* bump google-auth-library from 9.11.0 to 9.15.1 ([5b0aab4](https://github.com/madisonbikes/bikeweek-backend/commit/5b0aab45b8d596f14c493bfc5b8755762bc8dd1a))
...
* bump google-auth-library from 9.9.0 to 9.10.0 ([182909b](https://github.com/madisonbikes/bikeweek-backend/commit/182909b011448fdd417b325320daa59112883924))
...
* bump helmet from 7.1.0 to 8.0.0 ([90ffd1a](https://github.com/madisonbikes/bikeweek-backend/commit/90ffd1a598b19c8f0872457a056db5d361af585b))
...
* bump hono from 4.7.2 to 4.7.4 ([25f2392](https://github.com/madisonbikes/bikeweek-backend/commit/25f2392512e3611ba29d024c3789975df99f54cc))
...
* bump hono from 4.7.4 to 4.7.5 ([32f2ac9](https://github.com/madisonbikes/bikeweek-backend/commit/32f2ac9af98fa7b7cc2c67383f4563b3740a1a74))
* bump hono from 4.7.4 to 4.7.5 ([621f50a](https://github.com/madisonbikes/bikeweek-backend/commit/621f50ae762e8df5b5fa4f1d6554eb36e69050ac))
* bump hono from 4.7.5 to 4.7.6 ([1ad621c](https://github.com/madisonbikes/bikeweek-backend/commit/1ad621c9e63ef300e75f75579040830b75f08b7b))
* bump hono from 4.7.5 to 4.7.6 ([9acf9a6](https://github.com/madisonbikes/bikeweek-backend/commit/9acf9a65e9b99a27f8afdd0ece01da53209a6dd9))
* bump hono from 4.7.6 to 4.7.7 ([5d561eb](https://github.com/madisonbikes/bikeweek-backend/commit/5d561ebf4c039f0aae3d698883ed7ca504d0fbff))
* bump hono from 4.7.6 to 4.7.7 ([49620e1](https://github.com/madisonbikes/bikeweek-backend/commit/49620e1b8fa80a1e7ecc75dbb20501276955780d))
* bump hono from 4.7.7 to 4.7.8 ([1d7883a](https://github.com/madisonbikes/bikeweek-backend/commit/1d7883ac02b34dcf599a0d7be8f94d069982633e))
* bump hono from 4.7.7 to 4.7.8 ([d49365e](https://github.com/madisonbikes/bikeweek-backend/commit/d49365eda328b49e936907a1b1666c510310834f))
* bump hono-sessions from 0.7.1 to 0.7.2 ([20606b0](https://github.com/madisonbikes/bikeweek-backend/commit/20606b0ba92c8920b99197330a427f4692a96f5b))
* bump hono-sessions from 0.7.1 to 0.7.2 ([03fb3a1](https://github.com/madisonbikes/bikeweek-backend/commit/03fb3a1ec0a75e6262597b8bb581270c94955173))
* bump mongodb from 6.14.0 to 6.14.2 ([139be11](https://github.com/madisonbikes/bikeweek-backend/commit/139be117a5abb434ea0d46ed2867175234a00440))
...
* bump mongodb from 6.14.2 to 6.15.0 ([926e0c3](https://github.com/madisonbikes/bikeweek-backend/commit/926e0c3bd78a8e98c48422dfc2ce62f9ba3cbe63))
* bump mongodb from 6.14.2 to 6.15.0 ([11f1760](https://github.com/madisonbikes/bikeweek-backend/commit/11f1760fa5517aaf898334ebb781a11d7b6436ae))
* bump mongodb from 6.15.0 to 6.16.0 ([7919329](https://github.com/madisonbikes/bikeweek-backend/commit/7919329f02cfe14dd0e62a01d03c5cdf627d278a))
* bump mongodb from 6.15.0 to 6.16.0 ([931abb0](https://github.com/madisonbikes/bikeweek-backend/commit/931abb0aad0233a915c59dc155ef28fc1021d15e))
* bump mongodb from 6.5.0 to 6.7.0 ([2fc5899](https://github.com/madisonbikes/bikeweek-backend/commit/2fc5899d80819b58c8b938d7444533a83ac00d35))
...
* bump mongodb from 6.7.0 to 6.8.0 ([0426f44](https://github.com/madisonbikes/bikeweek-backend/commit/0426f44c56740530da9577281317b61a66519ebc))
...
* bump mongodb from 6.8.0 to 6.14.0 ([ad8352f](https://github.com/madisonbikes/bikeweek-backend/commit/ad8352f234968748923ffb873d8380faaac80e06))
...
* bump pino from 9.0.0 to 9.1.0 ([3f918ac](https://github.com/madisonbikes/bikeweek-backend/commit/3f918acb61c0f0b176aee555cdeff182af132786))
...
* bump pino from 9.1.0 to 9.2.0 ([efc3523](https://github.com/madisonbikes/bikeweek-backend/commit/efc3523d4eb1ecb572735dd49e95ba68477359a2))
...
* bump pino from 9.2.0 to 9.6.0 ([9367931](https://github.com/madisonbikes/bikeweek-backend/commit/93679312ebfa001cb2c07c8b449c289ac4f25f8e))
...
* bump pino-pretty from 11.0.0 to 11.1.0 ([745c9d6](https://github.com/madisonbikes/bikeweek-backend/commit/745c9d6d754d8d2e776330d6781e2229871cd6cd))
...
* bump pino-pretty from 11.1.0 to 11.2.1 ([5dbc2ff](https://github.com/madisonbikes/bikeweek-backend/commit/5dbc2ffb601732814c6c60e6078a78ca35234efe))
...
* bump pino-pretty from 11.2.1 to 13.0.0 ([7a0245b](https://github.com/madisonbikes/bikeweek-backend/commit/7a0245b5c612e7e6ab1b7fe90c9279ba48ab2e96))
...
* bump redis from 4.6.13 to 4.6.14 ([ddbc65b](https://github.com/madisonbikes/bikeweek-backend/commit/ddbc65b205790fe003b4c4ff02b9c799ae9a48a6))
...
* bump redis from 4.6.14 to 4.7.0 ([0d5a22e](https://github.com/madisonbikes/bikeweek-backend/commit/0d5a22e0bf048ba27763f06a7958891412855b2d))
...
* bump superagent from 10.1.1 to 10.2.0 ([afbc62e](https://github.com/madisonbikes/bikeweek-backend/commit/afbc62eb7c674aafbaa1e3fb3e22fd311eb23ac9))
* bump superagent from 10.1.1 to 10.2.0 ([0f1eaec](https://github.com/madisonbikes/bikeweek-backend/commit/0f1eaecb89095cdaaf0709b71ae7bcdf5eb658ba))
* bump superagent from 9.0.2 to 10.1.1 ([efdb459](https://github.com/madisonbikes/bikeweek-backend/commit/efdb4594c2163efb92788387756beb1409c1332a))
...
* bump zod from 3.23.5 to 3.23.8 ([9544746](https://github.com/madisonbikes/bikeweek-backend/commit/954474641fb3edc87face6a529ee36538d260af5))
...
* bump zod from 3.23.8 to 3.24.2 ([7185a9a](https://github.com/madisonbikes/bikeweek-backend/commit/7185a9a1db67dbf88f5c37a8cc20ae88bd88919c))
...
* bump zod from 3.24.2 to 3.24.3 ([fef6294](https://github.com/madisonbikes/bikeweek-backend/commit/fef62941800537087a48d48a521423c547cee588))
* bump zod from 3.24.2 to 3.24.3 ([0244887](https://github.com/madisonbikes/bikeweek-backend/commit/02448878174949107c4bf1db026ebb70cbd985ca))
...
* use nullish coalescing for default roles in mapDbUserToExternalUser ([c59539a](https://github.com/madisonbikes/bikeweek-backend/commit/c59539a9ea6677d2a47ba8495d2fb70255a60eab))
